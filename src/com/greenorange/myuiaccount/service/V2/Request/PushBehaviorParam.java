...
public class PushBehaviorParam extends BaseRequestParam{
	private String data;
	...
	public boolean checkValid() {
	 ...
	 public PushBehaviorParam(){this(null);}


	public PushBehaviorParam(PushBehaviorParam pushParam) {
        if(pushParam != null){
            data  = pushParam.data;
	...
	public String getRequestParam() {
		...
		try {
			PushBehaviorParam pushParam = new PushBehaviorParam(PushBehaviorParam.this);
