...
public class ServiceV1API {
    ...
    public static boolean API_MYUI_Logain_sync(LogainParam logainParam, IRequestCallBack callBack) throws Exception {
        return API_MYUI_Request_Sync(Config.getURL_UserLogin(), logainParam, callBack);
    }
    public static boolean API_MYUI_Logain_async(LogainParam logainParam, IRequestCallBack callBack) throws Exception {
        return API_MYUI_Request_Async(Config.getURL_UserLogin(), logainParam, callBack);
    }
    ///////////////////////////////////////////////////
    //public static BaseResponse
    public static boolean API_MYUI_Request_Sync(String url, BaseRequestParam baseRequestParam, final IRequestCallBack callBack) throws Exception {
        return RequestHelper.Request_Sync(url, baseRequestParam, callBack);
    }
    public static boolean API_MYUI_Request_Async(String url, BaseRequestParam baseRequestParam, final IRequestCallBack callBack) throws Exception {
